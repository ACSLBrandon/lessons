  ...
  return (
    <main className="p-6 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-2 md:grid-cols-7 items-start">
        ...
        <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-8 gap-2 items-start">
            ...
            <input value={newActivityDesc} onChange={e=>setNewActivityDesc(e.target.value)} placeholder="Description (optional)" className="border rounded px-3 py-2 h-10 md:col-span-4"/>
